      ...
      <div className="container-x max-w-6xl mx-auto grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-1.5 text-xs">
            {NAV_LINKS.map((l) => (
              <li key={l.href}>
                <a href={l.href} className="transition-colors hover:text-accent text-white/60 hover:text-white">
                  {l.label}
                </a>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="mt-3 space-y-1.5 text-xs">
            {COURSES.slice(0, 6).map((c) => (
              <li key={c.id}>
                <a href="#courses" className="transition-colors hover:text-accent text-white/60 hover:text-white truncate block">
                  {c.title}
                </a>
              </li>
            ))}
